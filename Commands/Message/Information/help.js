...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    ...
    let help_embed = new MessageEmbed()
      ...
      .setDescription(" • Prefix for this server is `.`\n• Total commands: 78\n• [Invite](https://discord.com/api/oauth2/authorize?client_id=893004037086121984&permissions=84992&scope=bot%20applications.commands) | [Join](https://discord.gg/Ktep2Amy7d)\n > 🤴 **__My Categories are__** :\n\n >>>   🏠  Home\n📺  Channel\n😄  Fun\n🎮   Games\nℹ️   Information\n🆙   Moderation\n🎵  Music\n⚙️  Settings\n🔧  Utility")
      .addField("🤴 **__STATS:__**",
