...
module.exports = {
  TOKEN: process.env.
    TOKEN || "ODkzMDA0MDM3MDg2MTIxOTg0.GHp-0E.84HdwB9T97_D8lqIxnguyLP9eHAZtukUUHMags",
  ...
  embed: {
    ...
    footertext: "Welcome to GeneXis eSports | ",
    footericon: "🔥",
  },
  ...
  links: {
    DiscordServer: `https://discord.gg/Ktep2Amy7d`
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
